...
// 5. Задати клас "gallery" на батьківський елемент (div чи ul) та огорнути усі зображення галереї у посилання. В атрибут src зображення вказати шлях до малого зображення, а в атрибут href посилання -- шлях до великого.
